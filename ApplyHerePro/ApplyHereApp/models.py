...
class DailyLog(models.Model):
    job = models.ForeignKey(Job, on_delete=models.CASCADE, related_name='daily_logs')
    crew = models.ForeignKey(Crew, on_delete=models.SET_NULL, null=True, blank=True, related_name='daily_logs')
    ...
    work_notes = models.TextField(blank=True, null=True)  # Optional notes for additional details

    def __str__(self):
        return f"{self.date} - {self.job.job_type} - {self.units_completed} units completed"
